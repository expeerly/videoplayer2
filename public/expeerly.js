...
const index = require('./index-f1337b78.js');

window.expeerly.config = {
    locale: 'en',
    accentColor: '#4B49EB',
    storeId: '',
    theme: 'dark',
...
const ExpeerlyComponent = class {
    ...
    render() {
        if (this.loading) {
            return index.h("div", { style: { fontFamily: 'Mulish,sans-serif' } }, "Loading Expeerly reviews...");
        }
    ...
    renderBadge({ theme, expeerlyLogo, avgRating, totalReviews }) {
        ...
        return (index.h("div", { class: "expeerly--badge", style: {
            ...
            }, onClick: () => this.handleBadgeClick() }, index.h("img", { src: expeerlyLogo, alt: "Expeerly Reviewed", style: { height: logoHeight } }), index.h("div", { style: { display: 'flex', alignItems: 'center', gap: '6px' } }, index.h("span", { style: { fontWeight: '600' } }, avgRating), this.renderStarsInline(avgRating), index.h("span", { style: { color: '#FA0F9C', fontSize: '0.85rem' } }, "(", totalReviews, ")"))));
    }
    renderReviewBlock({ theme, expeerlyLogo, accentColor, reviews, avgRating, avgRatingStr, totalReviews }) {
        ...
        return (index.h("div", { class: "expeerly--reviewblock", style: { fontFamily: 'Mulish,sans-serif', margin: '20px auto', padding: '10px' } }, index.h("div", { style: { background: blockBg, color: blockFg, padding: '8px', borderRadius: '8px', marginBottom: '8px', maxWidth: '300px' } }, index.h("img", { src: expeerlyLogo, alt: "Expeerly Logo", style: { height: logoHeight } }), index.h("div", { style: { display: 'flex', alignItems: 'center', gap: '8px', marginTop: '6px' } }, index.h("div", { style: { fontSize: '14px', fontWeight: 'bold' } }, avgRatingStr), index.h("div", { style: { display: 'inline-flex', alignItems: 'center' } }, this.renderStarsInline(avgRating)), index.h("span", { style: { color: '#ff0080' } }, "(", totalReviews, " ", reviewLabel, ")"))), index.h("div", { style: { display: 'flex', gap: '16px', overflowX: 'auto' } }, reviews.map(r => this.renderReviewItem(r))), index.h("div", { style: { marginTop: '12px', fontSize: '14px', color: accentColor }, innerHTML: footerLabel })));
    }
    renderCarousel({ reviews, storeId }) {
        return (index.h("div", { class: "expeerly--carousel", style: { fontFamily: 'Mulish,sans-serif', margin: '20px auto', padding: '10px', borderRadius: '6px' } }, index.h("div", { style: { display: 'flex', gap: '16px', overflowX: 'auto' } }, reviews.map(rev => {
            const playbackId = rev.mux_playback_id_text || '';
            return (index.h("div", { class: "expeerly--slide", style: {
                    position: 'relative',
                    width: '180px',
                    height: '320px',
                    borderRadius: '8px',
                    overflow: 'hidden',
                    flexShrink: '0',
                } }, playbackId ? (index.h("mux-player", { "playback-id": playbackId, "stream-type": "on-demand", controls: true, muted: true, "data-store-id": storeId, style: { width: '100%', height: '100%', objectFit: 'cover' } })) : (index.h("div", { style: {
                    width: '100%',
                    height: '100%',
                    background: '#ccc',
                    display: 'flex',
    ...
    renderStarsInline(avgRating) {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            if (filled) {
                stars.push(index.h("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "#FFD700", stroke: "#FFD700", style: { marginRight: '2px' } }, index.h("path", { d: "M12 17.27l6.18 3.73-1.64-7.08L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.68-1.64 7.08L12 17.27z" })));
            }
            else {
                stars.push(index.h("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "#E8E8EA", stroke: "none", "stroke-width": "2", style: { marginRight: '2px' } }, index.h("path", { d: "M12 17.27l6.18 3.73-1.64-7.08L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.68-1.64 7.08L12 17.27z" })));
            }
        }
        return index.h("span", { style: { display: 'inline-flex' } }, stars);
    }
    renderReviewItem(reviewData) {
        ...
        return (index.h("div", { style: {
            ...
            } }, playbackId ? (index.h("mux-player", { "playback-id": playbackId, "stream-type": "on-demand", controls: true, muted: true, "data-store-id": this.storeId, style: { width: '100%', height: '100%', objectFit: 'cover' } })) : (index.h("div", { style: {
                width: '100%',
                height: '100%',
                background: '#ccc',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
            } }, "No video")), index.h("div", { style: { position: 'absolute', top: '8px', left: '8px', color: 'white' } }, index.h("div", { style: { display: 'flex', marginBottom: '4px' } }, this.renderStarsInline(rating))), index.h("div", { style: {
                position: 'absolute',
                bottom: '0',
                left: '0',
                width: '100%',
                ...
                gap: '8px',
                fontSize: '0.9rem',
            } }, index.h("div", { style: { width: '32px', height: '32px', borderRadius: '50%', flexShrink: '0' } }, index.h("img", { src: profilePic, alt: "Reviewer", style: { width: '32px', height: '32px', borderRadius: '50%', objectFit: 'cover' } })), index.h("div", { style: { display: 'flex', alignItems: 'center', gap: '6px' } }, index.h("span", null, firstName, " ", shortLast), index.h("svg", { style: { width: '16px', height: '16px', borderRadius: '50%', background: '#1ecbe1', fill: 'white' }, viewBox: "0 0 24 24" }, index.h("path", { d: "M9 16.17l-3.88-3.88-1.42 1.42L9 19l10-11-1.41-1.41z" }))))));
    }
    getExpeerlyLogo() {
...
exports.expeerly_component = ExpeerlyComponent;

//# sourceMappingURL=expeerly-component.cjs.entry.js.map